...
class search(commands.Cog):
    ...
    async def player(self ,ctx, *, player : str = None):
        ...
        embed.add_field(name='PvE Fame', value=data2['LifetimeStatistics']['PvE']['Total'], inline=False)
        embed.add_field(name='Gathering Fame', value=data2['LifetimeStatistics']['Gathering']['All']['Total'], inline=False)
        embed.add_field(name='Crafting Fame', value=data2['LifetimeStatistics']['Crafting']['Total'], inline=False)
        print(data2['LifetimeStatistics']['PvE']['Total'])
        print(data2['LifetimeStatistics']['Gathering']['All']['Total'])
        print(data2['LifetimeStatistics']['Crafting']['Total'])
        print(data2['LifetimeStatistics']['CrystalLeague'])
